                ...
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="body">
                                <form action="/songer/update" data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="user-form" />
                                ...
                                <fieldset>
                                            ...
                                            <div data-toggle="buttons" class="btn-group col-sm-2 " >
                                                <select id="tid" name="tid" class="form-control ">
                                                    ...
                                                    <c:forEach var="mtype" items="${mtypes}">
                                                        <option <c:if test="${songer.tid == mtype.tid}">selected</c:if> value="${mtype.tid}">${mtype.tname}</option>
                                                    </c:forEach>
                                                </select>
                                        ...
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2" >
                                                <select id="isHot" name="isHot" class="form-control ">
                                                    <option value="1" <c:if test="${songer.tid == 1}">selected</c:if>>是</option>
                                                    <option value="0" <c:if test="${songer.tid == 0}">selected</c:if>>否</option>
                                                </select>
                                    ...
                                    <div class="control-group">
                                                ...
                                                <div class="image-row">
                                                    <div class="image-set">
                                                        <a class="example-image-link" href="../../img/gallery-photo/image-3.jpg" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
                                                            <img id="songerImg" class="example-image" src="${path}${songer.pic}" alt="Plants: image 1 0f 4 thumb" width="150" height="150" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="examples" class="section examples-section">
                                            ...
                                            <input type="hidden" name="pic" id="pic" value="${songer.pic}" lay-verify="pic"/>
                                ...
                                <div class="form-actions text-right">
                                    <button class="btn btn-primary" type="submit">修改艺人</button>
                                </div>
                                </form>
                            </div>
                        </div>
